...
pub struct IncreasePositionShortParams {
    pub price: u64,
    pub collateral: u64,
...
#[derive(Accounts)]
pub struct IncreasePositionShort<'info> {
...
pub fn increase_position_short(
    ...
    let (
        ...
        let unrealized_interest_usd =
            collateral_custody.get_interest_amount_usd(&position, current_time)?;
    ...
    // Remove the position from stats before re-adding it with increased size
