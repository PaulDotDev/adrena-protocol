...
#[derive(Accounts)]
pub struct SetCustodyMaxCumulativeShortPositionSizeUsd<'info> {
    /// #1
...
pub struct SetCustodyMaxCumulativeShortPositionSizeUsdParams {
...
pub fn set_custody_max_cumulative_short_position_size_usd<'info>(
    ...
    custody.pricing.max_cumulative_short_position_size_usd =
