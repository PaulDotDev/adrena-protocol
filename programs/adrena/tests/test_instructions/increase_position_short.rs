use {
    ...
    adrena::{
        instructions::IncreasePositionShortParams,
...
pub async fn increase_position_short(
    ...
    let (ix_size, tx_used_cu) = utils::create_and_execute_adrena_ix(
        program_test_ctx,
        adrena::accounts::IncreasePositionShort {
            caller: owner.pubkey(),
            owner: owner.pubkey(),
            payer: payer.pubkey(),
        ...
        adrena::instruction::IncreasePositionShort {
            params: params.clone(),
        },
        Some(&payer.pubkey()),
        &[owner, payer],
    ...
    utils::log_instruction("increase_position_short", "public", ix_size, tx_used_cu);
