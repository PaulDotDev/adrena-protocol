use {
    ...
    adrena::{instructions::GetAddLiquidityAmountAndFeeParams, state::cortex::AmountAndFee},
...
pub async fn get_add_liquidity_amount_and_fee(
    ...
    let result: AmountAndFee = utils::create_and_simulate_cortex_view_ix(
        program_test_ctx,
        adrena::accounts::GetAddLiquidityAmountAndFee {
            cortex: cortex_pda,
            pool: *pool_pda,
            custody: custody_pda,
            oracle: oracle_pda,
        ...
        adrena::instruction::GetAddLiquidityAmountAndFee {
            params: params.clone(),
        },
        payer,
