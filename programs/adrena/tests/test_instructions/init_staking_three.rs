...
pub async fn init_staking_three(
    ...
    let (ix_size, tx_used_cu) = utils::create_and_execute_adrena_ix(
        program_test_ctx,
        adrena::accounts::InitStakingThree {
            admin: admin.pubkey(),
            payer: payer.pubkey(),
        ...
        adrena::instruction::InitStakingThree {},
        Some(&payer.pubkey()),
        &[admin, payer],
        None,
        None,
    ...
    utils::log_instruction("init_staking_three", "admin", ix_size, tx_used_cu);
