...
pub async fn init_staking_four(
    ...
    let (ix_size, tx_used_cu) = utils::create_and_execute_adrena_ix(
        program_test_ctx,
        adrena::accounts::InitStakingFour {
            admin: admin.pubkey(),
            payer: payer.pubkey(),
        ...
        adrena::instruction::InitStakingFour {},
        Some(&payer.pubkey()),
        &[admin, payer],
        None,
        None,
    ...
    utils::log_instruction("init_staking_four", "admin", ix_size, tx_used_cu);
