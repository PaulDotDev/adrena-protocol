...
pub async fn get_liquidation_price() {
    ...
    // Get liquidation price from view
    {
        let liquidation_price_from_view = test_instructions::get_liquidation_price(
            &test_setup.program_test_ctx,
            &test_setup.payer_keypair,
            &test_setup.pool_pda,
            &martin.pubkey(),
            ...
            adrena::instructions::GetLiquidationPriceParams {
                add_collateral: 0,
                remove_collateral: 0,
                oracle_prices: Some(
        ...
        assert_eq!(liquidation_price_from_view, 14750000209925);
    }
    ...
    // Get liquidation price from view
    {
        ...
        assert_eq!(liquidation_price_from_view, 14750000119900);
    }
    ...
    // Get liquidation price from view
    {
        ...
        assert_eq!(liquidation_price_from_view, 14750000931329);
    }
}
