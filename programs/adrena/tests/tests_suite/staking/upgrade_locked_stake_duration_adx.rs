...
pub async fn upgrade_locked_stake_duration_adx() {
    ...
    // Do some should fail first

    // Upgrade to lower duration (should fail)
    {
    ...
    // Upgrade to invalid duration (should fail)
    {
        assert!(test_instructions::upgrade_locked_stake(
            &test_setup.program_test_ctx,
            alice,
    ...
    // Upgrade to the same duration (should fail)
    {
        assert!(test_instructions::upgrade_locked_stake(
            &test_setup.program_test_ctx,
            alice,
    ...
    // Upgrade the stake duration to 540 (totalling 2)
    {
    ...
    // Claim when there is one round worth of rewards to claim
    {
        ...
        //           2.5 + 5 = 33 %
        //           2 * 2.5 + 5 = 50%
        // 23888888888 * 3 = 71,666,666,664
        // 34506172839 * 2 = 69,012,345,678
        assert_eq!(balance_after - balance_before, 33333);
        assert_eq!(lm_balance_after - lm_balance_before, 34506172839);
    }
