...
pub async fn increase_position_short_issue_positive() {
    ...
    // Makes JITOSOL price decrease of 10%
    test_setup
        .update_oracle_price("jitoSOL", utils::scale(90, Cortex::PRICE_DECIMALS), 0)
        .await;

    // Makes SOL price decrease of 10%
    test_setup
    ...
    assert_eq!(pnl.profit_usd, 49150000);
    ...
    assert_eq!(pnl.loss_usd, 0);
    assert_eq!(pnl.profit_usd, 48349999);
