...
pub async fn increase_position_long_issue_negative() {
    ...
    // Makes JITOSOL price decrease of 20%
    test_setup
        .update_oracle_price("jitoSOL", utils::scale(80, Cortex::PRICE_DECIMALS), 0)
        .await;
    ...
    assert_eq!(pnl.loss_usd, 100550000);
    ...
    assert_eq!(pnl.profit_usd, 0);
    assert_eq!(pnl.loss_usd, 101190000);
    assert_eq!(pnl.exit_fee_usd, 1440000);
}
