...
pub async fn increase_position_long_issue_positive() {
    ...
    assert_eq!(pnl.profit_usd, 497950000);
    ...
    assert_eq!(pnl.loss_usd, 0);
    assert_eq!(pnl.profit_usd, 496349999);
    assert_eq!(pnl.exit_fee_usd, 2400000);
}
