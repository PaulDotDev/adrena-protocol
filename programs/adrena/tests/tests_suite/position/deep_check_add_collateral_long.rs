...
pub async fn deep_check_add_collateral_long() {
    let base_eth_price: u64 = 15000000000000;
    ...
    // Simple add collateral long (1ETH) (and mandatory previous open position (Long 1 ETH 10x leverage))
    {
        ...
        let added_collateral_eth = utils::scale(1, ETH_DECIMALS);
        let collateral_usd_value = 1496250000; //utils::scale(1_500, Cortex::USD_DECIMALS);
        let added_collateral_usd_value = 1496250000; // utils::scale(1_500, Cortex::USD_DECIMALS);
        let leverage = 10;
        ...
        // Alice: Add 1 ETH collateral to long position
        test_instructions::add_collateral_long(
            ...
            AddCollateralLongParams {
                collateral: added_collateral_eth,
                oracle_prices: Some(
                    utils::get_oracle_prices_as_chaos_labs_bundle(&test_setup.program_test_ctx)
                        .await,
                ),
        ...
        // Check position
        {
            ...
            assert_eq!(
                ...
                collateral_usd_value + added_collateral_usd_value
            );
            ...
            assert_eq!(
                ...
                collateral_eth + added_collateral_eth
            );
        ...
        // Check custodies
        {
            ...
            // Asset owned must match the actual amount in the token account
            {
                ...
                assert_eq!(
                    ...
                    Assets {
                        collateral: collateral_eth + added_collateral_eth,
                        owned,
                ...
                assert_eq!(
                    ...
                    initial_add_liquidity_eth_amount + collateral_eth + added_collateral_eth
                );
            }
            ...
            assert_eq!(
                ...
                PositionsAccounting {
                    ...
                    collateral_usd: collateral_usd_value + added_collateral_usd_value,
