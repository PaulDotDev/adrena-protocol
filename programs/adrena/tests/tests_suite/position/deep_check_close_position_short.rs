...
pub async fn deep_check_close_position_short() {
    ...
    // Simple close position (with mandatory prior open position (Short 1 ETH 10x leverage, using USDC as collateral))
    {
        // GIVEN --------------------------------------------------------------
        ...
        test_instructions::close_position_short(
            ...
            ClosePositionShortParams {
                ...
                price: Some(utils::scale(1600, Cortex::PRICE_DECIMALS)),
                oracle_prices: Some(
                    utils::get_oracle_prices_as_chaos_labs_bundle(&test_setup.program_test_ctx)
                        .await,
                ),
        ...
        let collateral_usd_value = 1498500000; // based on the confidence
        let real_position_size_usd = (collateral_usd_value) * leverage;
        let exit_fee = 26973071; //real_position_size * 10 / Cortex::BPS_POWER as u64; // 10 bps fees // + borrow
        ...
        // Check Alice token accounts
        {
            ...
            assert_eq!(alice_usdc_before - alice_usdc_after, exit_fee);
        ...
        // Check custodies
        {
            ...
            assert_eq!(
                ...
                VolumeStats {
                    ...
                    close_position_usd: real_position_size_usd,
                    liquidation_usd: 0,
            ...
            assert_eq!(
                ...
                FeesStats {
                    ...
                    remove_liquidity_usd: 0,
                    close_position_usd: exit_fee_usd,
                    liquidation_usd: 0,
                    swap_usd: 0,
                    borrow_usd: 44,
                },
            ...
            assert_eq!(
                ...
                TradeStats {
                    profit_usd: 0,
                    loss_usd: 24000044, // loss + borrow 44
                    oi_long_usd: 0,
                    oi_short_usd: 0,
                },
            );
