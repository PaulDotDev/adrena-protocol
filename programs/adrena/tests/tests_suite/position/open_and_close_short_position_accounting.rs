        ...
        // Double check effect of closing position on SOL custody accounting
        {
            ...
            // Trade Stats
            {
                // SOL
                {
                    ...
                    assert_eq!(after.oi_short_usd, 0);

                    assert_eq!(after.profit_usd - before.profit_usd, 147435001);
                }
            ...
            // Short positions
            {
                // SOL
                {
                    ...
                    assert_eq!(before.open_positions - after.open_positions, 1);
                    assert_eq!(before.size_usd - after.size_usd, 1498500000);
                    assert_eq!(
                ...
                // USDC
                {
                    ...
                    assert_eq!(before.open_positions - after.open_positions, 1);
                    assert_eq!(before.borrow_size_usd - after.borrow_size_usd, 1498500000);
                    assert_eq!(before.locked_amount - after.locked_amount, 1500000000);
