...
pub async fn deep_check_close_position_long() {
    ...
    // Simple open position (Long 1 ETH 10x leverage)
    {
        ...
        test_instructions::close_position_long(
            ...
            ClosePositionLongParams {
                ...
                price: Some(utils::scale(1330, Cortex::PRICE_DECIMALS)),
                oracle_prices: Some(
                    utils::get_oracle_prices_as_chaos_labs_bundle(&test_setup.program_test_ctx)
                        .await,
                ),
        ...
        let exit_fee = 20947661; // borrow of MIN_POSITION_OPEN_TIME_SECONDS
        let exit_fee_usd = 24000000;
        ...
        // Check Alice token accounts
        {
            ...
            assert_eq!(alice_eth_before - alice_eth_after, exit_fee);
        ...
        // Check custodies
        {
            ...
            {
                let owned = initial_add_liquidity_eth_amount + exit_fee;
