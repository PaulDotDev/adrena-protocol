...
pub async fn deep_check_open_position_long() {
    let base_eth_price = 15000000000000;
    // let base_eth_price_low =    14999999900000;
    ...
    // Simple open position (Long 1 ETH 10x leverage)
    {
        // GIVEN --------------------------------------------------------------
        ...
        let exit_fee_usd = 24000000; //real_position_size_usd * 10 / Cortex::BPS_POWER as u64; // 10 bps fees
                                     // let exit_fee = real_position_size * 10 / Cortex::BPS_POWER as u64; // 10 bps fees
        ...
        // Check position
        {
            ...
            assert_eq!(position.collateral_usd, collateral_usd_value);
            ...
            assert_eq!(position.collateral_amount, collateral_eth);
        ...
        // Check Alice token accounts
        {
            ...
            // Alice paid 1 ETH
            assert_eq!(alice_eth_before - alice_eth_after, collateral_eth);
        ...
        // Check custodies
        {
            ...
            // Asset owned must match the actual amount in the token account
            {
                ...
                assert_eq!(
                    ...
                    initial_add_liquidity_eth_amount + collateral_eth
                );
            }
            ...
            assert_eq!(
                ...
                PositionsAccounting {
                    ...
                    collateral_usd: collateral_usd_value,
